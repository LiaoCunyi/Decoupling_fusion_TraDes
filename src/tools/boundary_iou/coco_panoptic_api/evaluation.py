...
if __name__ == "__main__":
    ...
    parser.add_argument("--dilation-ratio", default="0.02", type=float)
    args = parser.parse_args()
    assert args.iou_type in ["segm", "boundary"]
    pq_compute(args.gt_json_file, args.pred_json_file, args.gt_folder, args.pred_folder, args.iou_type,
               args.dilation_ratio)
